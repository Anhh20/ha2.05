	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIsland") then
			for r, v in pairs(game.workspace.Map.MysticIsland:GetChildren()) do
				if v:IsA("MeshPart") and v.MeshId == "rbxassetid://16295851234" then
					return v
				end
			end
		end
	...
	function getHighestPoint()
		...
		for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
			if v:IsA("MeshPart") then
				if v.MeshId == "rbxassetid://16295851234" then
					return v
				end
			end
		end
...
local Window = OrionLib:MakeWindow({Name = "ha.Hub", HidePremium = false, IntroText = "ha2.05 Library", SaveConfig = true, ConfigFolder = "ha2.05 Hub"})
----------Tab-----------------------
local W = Window:MakeTab({
    Name = "Thông Tin",
    Icon = "rbxassetid://16295851234",
    PremiumOnly = false
})
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "ha2.05 Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://16295851234",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "ha2.05 Hub(Noitification)",
